"""Bagels, by Emmanuel Almonte ammetronics67@gmail.com
...
MAX_GUESSES = 10 #(!) Try settings this to 1 or 100


def main():
    print('''Bagels, a deductive logic game. 
    By Emmanuel Amonte ammetronics67@gmail.com
    ...
    while True: #Main Game Loop.ArithmeticError
